...
import com.hanks.healthspy.utils.ImageProcessing;
...
public class CheckActivity extends Activity {
    ...
    public final static String EXTRA_MESSAGE = "com.hanks.healthspy.MESSAGE";
    //	曲线
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final Intent it = new Intent(this, CheckUploadActivity.class);
        Toast.makeText(getApplicationContext(), "将检测10秒，10秒后自动退出", Toast.LENGTH_LONG).show();
        ...
        endTask = new TimerTask() {
            @Override
            public void run() {
                it.putExtra(EXTRA_MESSAGE, String.valueOf(beatsAvg));
                startActivity(it);
...
//			addY=250;
            ...
            if(gx<200){
                if(hua[20]>1){
                    Toast.makeText(CheckActivity.this, "请用您的指尖盖住摄像头镜头！", Toast.LENGTH_SHORT).show();
                    hua[20]=0;}
                hua[20]++;
                return;}
            else
